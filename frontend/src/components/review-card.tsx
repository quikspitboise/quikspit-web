...
function StarIcon({ filled, className = '' }: { filled: boolean; className?: string }) {
  return (
    <svg aria-hidden="true" className={`w-4 h-4 ${filled ? 'text-brand-gold' : 'text-neutral-700'} ${className}`} fill="currentColor" viewBox="0 0 20 20">
    ...
    <GlassCard className="h-full flex flex-col" padding="md">
      <div className="flex items-center gap-3 mb-4">
        <div className="relative">
          {/* eslint-disable-next-line @next/next/no-img-element -- Google-hosted avatar, not worth optimizing */}
          <img
      ...
      <div className="flex-1">
        <p className="text-neutral-300 text-[0.9375rem] leading-relaxed text-pretty">
