...
const footerLinks = {
  services: [
    { label: 'Exterior & Interior', href: '/pricing' },
    { label: 'Ceramic Coatings', href: '/pricing' },
    { label: 'Premium Packages', href: '/pricing' },
...
const socialLinks = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/quikspit_shine',
    icon: (
  ...
  {
    label: 'TikTok',
    href: 'https://www.tiktok.com/@quikspit_shine',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/quikspitshine',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 lg:py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link href="/" aria-label="QuikSpit Shine - Home">
              <Logo responsive className="mb-5" />
            </Link>
            <p className="text-neutral-500 text-sm leading-relaxed mb-6 max-w-xs">
              Professional mobile detailing in the Boise area. We bring showroom-quality results directly to your door.
            </p>
            {/* Social links */}
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-white/[0.04] border border-white/[0.06] flex items-center justify-center text-neutral-500 hover:text-white hover:bg-red-600/10 hover:border-red-600/30 transition-all duration-300"
                >
                  {social.icon}
                </a>
              ))}
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-neutral-500 hover:text-white text-sm transition-colors duration-300"
                >
                  <svg className="w-4 h-4 text-red-500/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="py-5 border-t border-white/[0.05] flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <Link
            ...
            className="text-xs text-red-500/70 hover:text-red-400 transition-colors duration-300 font-medium tracking-wide"
          >
            Book Your Detail →
          </Link>
        </div>
