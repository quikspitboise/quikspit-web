...
const pricingCategories = [
  ...
  },
  {
    id: 'interior',
    label: 'Interior Only',
    blurb: 'Deep interior cleaning and restoration for a fresh cabin feel.',
    packages: [
      {
        id: 'silver',
        name: 'Silver Package',
      ...
      },
      {
        ...
        name: 'Gold Package',
        tagline: 'The Prestige Clean',
        description: 'Enhanced interior detailing.',
        basePrice: 160,
        highlight: true,
        features: [
          'Includes everything in Silver Package, plus:',
      ...
      },
      {
        ...
        name: 'Platinum Package',
        tagline: 'Executive Treatment',
        description: 'The ultimate interior experience.',
        basePrice: 200,
        features: [
          'Includes everything in Gold Package, plus:',
          'Enzyme odor eliminator',
  ...
  },
  {
    id: 'exterior',
    label: 'Exterior Only',
    blurb: 'Professional exterior cleaning and paint protection.',
    packages: [
      {
        id: 'silver',
        name: 'Silver Package',
      ...
      },
      {
        ...
        name: 'Gold Package',
        tagline: 'The Prestige Clean',
        description: 'Enhanced exterior detailing.',
        basePrice: 120,
        highlight: true,
        features: [
          'Includes everything in Silver Package, plus:',
      ...
      },
      {
        ...
        name: 'Platinum Package',
        tagline: 'Executive Treatment',
        description: 'The ultimate exterior finish.',
        basePrice: 180,
        features: [
          'Includes everything in Gold Package, plus:',
          'Paint decontamination',
